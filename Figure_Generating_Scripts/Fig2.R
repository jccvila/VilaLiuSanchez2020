...
if(null==0){ggsave('../Final Figures/Fig2.png',grid.arrange(pmid,pbottom,p_extra,nrow=3,heights=c(6,6,6)),width=8,height=12)
}else{ggsave('../Final Figures/FigS7.png',grid.arrange(pbottom),width=8,height=4)
  }