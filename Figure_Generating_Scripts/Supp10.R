...
p1 <- plot_lowess(doc_df,'../Stat_Outputs/DOC_stats_L.csv',med) +  theme_bw() + theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank()) +
  theme(axis.title=element_text(size=16))
p1b <- plot_olm(doc_df,'../Stat_Outputs/DOC_stats_L.csv',med)+  theme_bw()  + 
...
pB <- plot_olm(doc_df[Same_Environment==TRUE & Same_Inoculum==TRUE],'../Stat_Outputs/DOC_stats_M.csv',med)+  theme_bw()  + 
#  theme(axis.title=element_blank(),axis.ticks=element_blank(),axis.text = element_blank()) +
  theme(plot.margin = margin(0, 0, 0, 0, "cm"),panel.grid.major = element_blank(), panel.grid.minor = element_blank())

pC <- plot_olm(doc_df[Same_Environment==TRUE & Same_Inoculum==FALSE],'../Stat_Outputs/DOC_stats_N.csv',med)+  theme_bw()  + 
 # theme(axis.title=element_blank(),axis.ticks=element_blank(),axis.text = element_blank()) +
  theme(plot.margin = margin(0, 0, 0, 0, "cm"),panel.grid.major = element_blank(), panel.grid.minor = element_blank())

pD <- plot_olm(doc_df[Same_Environment==FALSE & Same_Inoculum==TRUE],'../Stat_Outputs/DOC_stats_O.csv',med)+  theme_bw()  + 
  #theme(axis.title=element_blank(),axis.ticks=element_blank(),axis.text = element_blank()) +
  theme(plot.margin = margin(0, 0, 0, 0, "cm"),panel.grid.major = element_blank(), panel.grid.minor = element_blank())

pE <- plot_olm(doc_df[Same_Environment==FALSE & Same_Inoculum==FALSE],'../Stat_Outputs/DOC_stats_P.csv',med)+  theme_bw()  + 
  #theme(axis.title=element_blank(),axis.ticks=element_blank(),axis.text = element_blank()) +
  theme(plot.margin = margin(0, 0, 0, 0, "cm"),panel.grid.major = element_blank(), panel.grid.minor = element_blank())

pB <- ggarrange(pB + theme_bw() + labs(x='',y='') +theme(plot.margin = margin(0, 0, 0, 0, "cm"),panel.grid.major = element_blank(), panel.grid.minor = element_blank()) ,labels='C')
pC <- ggarrange(pC + theme_bw() + labs(x='',y='') +theme(plot.margin = margin(0, 0, 0, 0, "cm"),panel.grid.major = element_blank(), panel.grid.minor = element_blank()) ,labels='D')
pD <- ggarrange(pD + theme_bw() + labs(x='',y='') +theme(plot.margin = margin(0, 0, 0, 0, "cm"),panel.grid.major = element_blank(), panel.grid.minor = element_blank()) ,labels='E')
pE <- ggarrange(pE + theme_bw() + labs(x='',y='') +theme(plot.margin = margin(0, 0, 0, 0, "cm"),panel.grid.major = element_blank(), panel.grid.minor = element_blank()) ,labels='F')
...
pRight <- add_vp(pRight)
p = grid.arrange(pLeft,pRight,ncol=2) 
save_plot('../Final Figures/Supp10.png',p,base_height=13.5/2.8,base_width=27/2.8)
# 
