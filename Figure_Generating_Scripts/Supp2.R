...
plot_olm_cs<- function(dat,med){
  ...
  sdataG= fread( '../Stat_Outputs/Curve_Fitting_Glucose_Citrate.csv')
  sdataC= fread( '../Stat_Outputs/Curve_Fitting_Citrate_Leucine.csv')
  sdataL= fread( '../Stat_Outputs/Curve_Fitting_Glucose_Leucine.csv')
...
pB <- plot_lowess(doc_df2,'../Stat_Outputs/Curve_Fitting_DiffEnv.csv',median(doc_df2$Overlap))
pBInset <- plot_olm(doc_df2,'../Stat_Outputs/Curve_Fitting_DiffEnv.csv',median(doc_df2$Overlap))+  
...
pD <- plot_olm(doc_df2[Same_Inoculum==TRUE],'../Stat_Outputs/Curve_Fitting_DiffEnvSameInoc.csv',median(doc_df2$Overlap))
pE <- plot_olm(doc_df2[Same_Inoculum==FALSE],'../Stat_Outputs/Curve_Fitting_DiffEnvDiffInoc.csv',median(doc_df2$Overlap)) 
...
ggsave(filename = '../Final_Figures/Supp2.png',grid.arrange(pleft,pmiddle,pright,
